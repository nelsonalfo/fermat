...
### How to create a reference wallet from scratch:
---------------------

1. Crear el codigo base del Android Reference Wallet, esto incluye:
     src/main/java/<wallet_package>/fragmentFactory/MyWalletFragmentFactory.java
     src/main/java/<wallet_package>/fragmentFactory/MyWalletFragmentsEnum.java
     src/main/java/<wallet_package>/fragments/MyWalletFragment.java
     src/main/java/<wallet_package>/preference_settings/MyWalletPreferenceSettings.java
     src/main/java/<wallet_package>/session/MyWalletSession.java

     src/main/res/drawable/
     src/main/res/layout/MyHomeLayout.xml
...
2. Crear el codigo base del wallet Module Manager Plugin y registrarlo en el core
Crear un MyWalletModuleManager interface en el API del platform
Crear un plugin MyWalletModule en el wallet_module layer
Registrar el MyWalletModule plugin en el core del platform


3. Registrar los Activities y Fragments en el fermat-api:
Ir a: fermat_api/layer/all_definition/navigation_structure/enums:
Activities enum: Ingresar los Activities del wallet(el home por ejemplo)
Fragments enum: Ingresar al menos in Fragment que pertenezca al home
...
4. Crear el Navigation Structure:
...
5. Crear un icono en el Desktop:
...
6. Registrar el FragmentFactory en el android-core:
...
7. Registrar el WalletSession en el android-core:
